            ...
            <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-xl w-full max-w-lg p-8 relative">
                ...
                <form className="space-y-4" onSubmit={handleSubmit}>
                    <div>
                        ...
                        <input name="fullName" type="text" placeholder="Your Name" className="w-full px-4 py-2 bg-gray-100 dark:bg-gray-700 border-transparent rounded-lg focus:ring-2 focus:ring-zan-blue transition-all" required />
                    </div>
                    <div>
                    ...
                    <div>
                        ...
                        <textarea name="reason" placeholder="Tell us about your passion for tech..." rows={4} className="w-full px-4 py-2 bg-gray-100 dark:bg-gray-700 border-transparent rounded-lg focus:ring-2 focus:ring-zan-blue transition-all" required></textarea>
                    </div>
